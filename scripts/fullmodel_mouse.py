...
parser.add_argument('--mouse_id', type=int, default=12, help='mouse id')
...
parser.add_argument('--nconv1', type=int, default=16, help='number of convolutional filters in first layer')
parser.add_argument('--nconv2', type=int, default=64, help='number of convolutional filters in second layer')
parser.add_argument('--nlayers', type=int, default=3, help='number of convolutional layers')
...
iv1, imedial = data.split_area(mouse_id, xpos, ypos, retinotopy_path=args.data_path)
if args.area == 1: # V1
    ineur = iv1
elif args.area == 2: # PM
    ineur = imedial
