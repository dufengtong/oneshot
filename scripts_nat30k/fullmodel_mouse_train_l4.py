...
def main():
    ...
    for mouse_id in [11,12]:
        ...
        # # for hs_readout in hs_list:
            ...
            bsub_cmd = f'bsub -n 2 -q gpu_l4 -gpu "num=1"  -J {prefix} -o {output_save_path}/{prefix}.out -e {output_save_path}/{prefix}.err "bash fullmodel_mouse_script_a100.sh {nlayers} {nconv1} {nconv2} {seed} {n_neuron} {n_stim_train} {weight_decay_core} {mouse_id} {conv1_ks} {conv2_ks} {pretrain_mouse_id} {hs_readout}"'
            print(bsub_cmd)
            os.system(bsub_cmd)
